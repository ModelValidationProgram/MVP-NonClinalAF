...
```{r}
colnames(subset_indPhen_df[,env_cols])
bioclim
pdf("plot_AFpatterns.pdf", width=3, height=8)
par(mar=c(1,2.5,1,0), mfrow=c(6,1))
matplot(t(mut_freq[[1]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Mean Annual Temperature")
matplot(t(mut_freq[[2]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Mean Temperature of Wettest Quarter")
matplot(t(mut_freq[[3]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Mean Temperature of Driest Quarter")
matplot(t(mut_freq[[4]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Precipitation of Driest Month")
matplot(t(mut_freq[[5]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Precipitation of Warmest Quarter")
matplot(t(mut_freq[[6]]), type="l", bty="l", ylab="", xlab="", xaxt = "n")#, main="Precipitation of Wettest Month")
dev.off()
```
