...
write.table(towrite[1:999,], "src/0b-final_params-fastruns-20220117.txt", row.names=FALSE)
write.table(towrite[1000:nrow(towrite),], "src/0b-final_params-fastruns-20220117-b.txt", row.names=FALSE)
nrow(final[longruns,])
write.table(final[longruns,], "src/0b-final_params-longruns-20220117.txt", row.names=FALSE)

save(final, file="src/0b-final_params-20220117.RData")
