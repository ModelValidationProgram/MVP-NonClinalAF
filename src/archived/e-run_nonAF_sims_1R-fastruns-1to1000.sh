...
#SBATCH --job-name=R-Run-20210920
#SBATCH --mail-user=k.lotterhos@northeastern.edu
#SBATCH --mail-type=FAIL
#SBATCH --partition=lotterhos
#SBATCH --mem=5G
#SBATCH --nodes=1
#SBATCH --array=1-1000%70
#SBATCH --output=/work/lotterhos/MVP-NonClinalAF/slurm_log/R-Run20210920_%j.out
#SBATCH --error=/work/lotterhos/MVP-NonClinalAF/slurm_log/R-Run20210920_%j.err
