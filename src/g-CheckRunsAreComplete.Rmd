...
sim.df1 <- read.table("src/0b-final_params-20220428.txt", header=TRUE)
...
```{r}
ran_mutpdf <- data.frame(seed = substr( system("ls sim_output_20220428/*_2muts.pdf", intern = TRUE), 21, 27), ran_mut = TRUE)
head(ran_mutpdf)
sum(ran_mutpdf$ran_mut)

ran_pca <- data.frame(seed = substr( system("ls sim_output_20220428/*_pdf_3pca.pdf", intern = TRUE), 21, 27), ran_pca = TRUE)
head(ran_pca)
