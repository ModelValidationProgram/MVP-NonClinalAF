...
knitr::opts_knit$set(root.dir = '/work/lotterhos/MVP-NonClinalAF')
library(ggplot2)
library(viridis)
library(gridExtra)
library(tidyr)
...
library(dplyr)
#library(tidyverse)
outputs <- "figures_20220428_20221112/"
```
...
system(paste0("cp sim_output_20220428/",i,"*.pdf figures_20220428_20221112/"))
...
# Seeds from Estuary sim, mod poly with high performance
  ...
  for (i in All_example_seeds){ #unhash to run
    file <- paste0("cp sim_output_20220428/",i,"*.pdf examples_20220428_20221112/")
    system(file)
  }
